-- ================================================================
-- MIGRATION 006: Actualizar defaults de match_count para reranking
-- ================================================================
-- El reranking necesita más candidatos iniciales del SQL.
-- Python ya pasa top_k * 3 como match_count, pero subimos el
-- default por si las funciones se llaman desde otro contexto.
--
-- EJECUTAR EN SUPABASE SQL EDITOR
-- ================================================================

-- search_knowledge: match_count default 10 → 20
...
-- search_project: match_count default 10 → 20
